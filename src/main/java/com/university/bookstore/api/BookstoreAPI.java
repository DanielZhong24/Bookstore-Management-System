...
public interface BookstoreAPI {
    ...
    *@return the{@link Book} objects, or an empty list if none are found
    */
    Book findByIsbn(String isbn);
    /**
    *finds all books that have titles matching the query given
    *@param titleQuery the tile or partial title to search for
    *@return a list of matching {@link Book} objects, or an empty list if none are found
    */
    List<Book> findByTitle(String titleQuery);
    /**
    *locates a book by the author's name
    *@param athorQuery the author's name or part of their name
    *@return a link of matching {@link Book} objects, or an empty list if none are found
    */
    ...
    *@return a list of {@link Book} objects within the specified range, or empty list if none are found
    */
    ...
    *@param year the publication year
    @return a list of { @link Book} objects that were published during that year or an empty list if there are none
    */
    ...
    *@return the {@link Book} with the highest price, or {@code null} if the inventory is empty
    **/
    double inventoryValue();
    /**
    * Gets the most expensive book in the inventory
    *@return the {blank Book} with the most recent publication year, or {@code null} if the inventory is empty
    */
    Book getMostExpensive();
    /**
    *gets the most recently published bood in the inventory
    *@return the {link Book} with the most recent publication year, or {@code null} if the inventory is empty
    */
    Book getMostRecent();
